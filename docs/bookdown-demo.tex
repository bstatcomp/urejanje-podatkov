...
V predpripravi se bomo naučili osnovnih klicev petih glagolov iz slovnice urejanja podatkov. Hkrati bomo primerjali osnovno različico R-ja z uporabo paketa dplyr. Pripravimo si podatke:
...
\hypertarget{predpriprava-1}{%
\section{Predpriprava}\label{predpriprava-1}}
